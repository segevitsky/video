(function () {
  ...
  */
  ...
  var url = 'https://video-project-c864d-default-rtdb.firebaseio.com/events.json';
  var events = [];
  ...
  function _getData() {
    _getData = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
      var data, json, result, viewsFromHtml, upCounter, downCounter;
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 8:
              ...
              events = result;
              viewsFromHtml = document.querySelector('.views');
              viewsFromHtml.innerHTML = events.views;
              upCounter = document.querySelector('.up-vote');
              upCounter.innerHTML = events.likes;
              downCounter = document.querySelector('.down-vote');
  ...
  firebase.analytics();
  var incrementViews = /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(id) {
      ...
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ref = firebase.database().ref('/events').child(id);
              ref.transaction(function (currentViews) {
    ...
    return function incrementViews(_x) {
      return _ref.apply(this, arguments);
    };
  }();
  incrementViews('views'); //  Like/Dislike handlers //

  var upCounter = document.querySelector('.up-vote');
  var downCounter = document.querySelector('.down-vote');
  ...
  if (supportsVideo) {
    ...
    var videoLength; // Hide the default controls

    video.controls = false; //Lets get our video length
    ...
    videoControls.setAttribute('data-state', 'visible'); // our video keys and progress bar
    ...
    var progressBar = document.getElementById('progress-bar'); // If the browser doesn't support the progress element, set its state for some different styling
